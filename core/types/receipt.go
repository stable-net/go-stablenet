...
func (rs Receipts) DeriveFields(config *params.ChainConfig, hash common.Hash, number uint64, time uint64, baseFee, gasTip *big.Int, blobGasPrice *big.Int, txs []*Transaction) error {
