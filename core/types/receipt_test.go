...
func TestDeriveFields(t *testing.T) {
	...
	minerTip := big.NewInt(1000)
	blobGasPrice := big.NewInt(920)
	derivedReceipts := clearComputedFieldsOnReceipts(receipts)
	err := Receipts(derivedReceipts).DeriveFields(params.TestChainConfig, blockHash, blockNumber.Uint64(), blockTime, basefee, minerTip, blobGasPrice, txs)
	if err != nil {
