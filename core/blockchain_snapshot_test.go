...
// It can be used for testing that restart Gstable normally.
...
// It can be used for testing that restart Gstable after the crash.
...
// Tests a Gstable restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gstable was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gstable was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gstable was running with snapshot enabled. Then restarts without
...
// Tests the Gstable was running with snapshot enabled and resetHead is applied.
...
// Tests the Gstable was running with a complete snapshot and then imports a few
