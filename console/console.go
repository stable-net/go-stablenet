...
// Welcome show summary of current Gstable instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gstable JavaScript console!\n\n"

	// Print some generic Gstable metadata
