...
func (l *StructLogger) CaptureTxStart(gasLimit uint64, authList []types.SetCodeAuthorization) {
	l.gasLimit = gasLimit
}
...
func (*mdLogger) CaptureTxStart(gasLimit uint64, authList []types.SetCodeAuthorization) {}
