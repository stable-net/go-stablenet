...
func (l *StructLogger) CaptureTxStart(gasLimit uint64, authList []types.Authorization) {
	l.gasLimit = gasLimit
}
...
func (*mdLogger) CaptureTxStart(gasLimit uint64, authList []types.Authorization) {}
